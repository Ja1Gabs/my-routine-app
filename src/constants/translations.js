export const TRANSLATIONS = {
  pt: {
    ...
    syncNowDesc: 'Forca o envio dos dados atuais para a sua conta',
    syncSuccess: 'Sincronizado com sucesso',
    syncError: 'Nao foi possivel sincronizar agora',
    logout: 'Sair',
    reset: 'Resetar',
    change: 'Alterar',
  ...
  en: {
    ...
    account: 'Account',
    syncNow: 'Sync now',
    syncNowDesc: 'Force-send the current data to your account',
    syncSuccess: 'Synced successfully',
    syncError: 'Could not sync right now',
    logout: 'Logout',
    reset: 'Reset',
    change: 'Change',
