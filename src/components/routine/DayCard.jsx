...
const DayCard = ({ 
  ...
  // Memoização para evitar inconsistências
  ...
  // Handlers atualizados com SNAPSHOT da activity
  const handleCompleteClick = (e) => {
    ...
    // O onToggleComplete no WeekView já deve chamar actions.toggleComplete(..., activity)
    onToggleComplete();
  };
  ...
  const toggleTask = (taskId) => {
    ...
    actions.updateDayData(actualDateStr, actualShiftKey, { tasks: updatedTasks }, activity);
  };
  ...
  const handleImageUpload = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => actions.updateDayData(actualDateStr, actualShiftKey, { image: reader.result }, activity);
            ...
            <div className="pt-4 space-y-4 pb-2">
              {dayImage && (
                <div className="relative rounded-xl overflow-hidden border border-border group">
                  ...
                  <button 
                    onClick={() => actions.updateDayData(actualDateStr, actualShiftKey, { image: null }, activity)} 
              ...
              <div>
                ...
                <textarea 
                  ...
                  value={dayNotes} 
                  onChange={(e) => actions.updateDayData(actualDateStr, actualShiftKey, { notes: e.target.value }, activity)} 
                />
              </div>
