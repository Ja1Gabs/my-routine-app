...
const DayCard = ({ 
  ...
  return (
    <motion.div
      ...
      className={`
        ...
        ${theme.card}
        ${isExpanded ? 'row-span-2 shadow-2xl z-10' : 'h-48 hover:-translate-y-1 hover:shadow-xl'}
      `}
    >
      {/* Header */}
  ...
  <div className="mb-2 p-2 bg-white/5 border border-white/10 rounded-md text-xs text-white/80 flex items-center gap-2">
    <span className="text-purple-400 font-bold">Sorteado:</span> {activity.assignedTask}
  </div>
)}
